<template>
  <div class="tw-text-center">
    ...
    <div class="tw-flex tw-justify-center tw-items-center tw-flex-wrap tw-mt-8">
      <div class="affiliate-card tw-w-full sm:tw-w-5/12 md:tw-w-1/3 xl:tw-w-1/4 tw-bg-secondary tw-border-t-2 tw-border-primary tw-shadow-md tw-p-4 sm:tw-mx-6 md:tw-mx-4">
      ...
      <div class="affiliate-card tw-w-full sm:tw-w-5/12 md:tw-w-1/3 xl:tw-w-1/4 tw-bg-secondary tw-border-t-2 tw-border-primary tw-shadow-md tw-p-4 sm:tw-mx-6 md:tw-mx-4 tw-mt-4 sm:tw-mt-0">
        <div class="tw-font-medium tw-text-xl tw-uppercase tw-tracking-wider tw-mb-1">
          TOTAL REVENUE
        </div>
        <div class="tw-mb-6">
