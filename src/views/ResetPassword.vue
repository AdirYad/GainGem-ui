<template>
  <div class="authentication-form bg-rectangles tw-w-screen tw-h-screen tw-flex tw-items-center tw-justify-center tw-flex-col tw-overflow-auto tw-p-10">
    ...
    <form @submit.prevent="resetPassword" class="tw-bg-white tw-shadow-lg tw-px-10 tw-py-12">
      <div class="tw-mb-6">
      ...
      <button v-if="! isResetting" class="tw-w-full tw-text-white tw-uppercase tw-border tw-border-primary tw-bg-primary tw-px-4 tw-py-1 focus:tw-outline-none" type="submit">
        Reset
      </button>
