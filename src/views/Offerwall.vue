  ...
  <div>
    <div class="tw-justify-between tw-flex tw-flex-wrap tw-mb-4">
      ...
      <div class="tw-bg-red-600 tw-w-full sm:tw-w-1/3 xl:tw-w-1/4 tw-h-12 tw-rounded-xl">
        <a href="https://gaingem.reamaze.com/kb/missing-points" target="_blank" class="tw-uppercase tw-tracking-wider tw-rounded-xl tw-w-full tw-h-full tw-flex tw-text-secondary tw-justify-center tw-items-center">
