<template>
  <div v-if="paymentsObj.available_earnings && paymentsObj.total_earnings && paymentsObj.total_withdrawals" class="tw-text-center tw-flex tw-flex-wrap tw-justify-center sm:tw-flex-no-wrap tw-mb-8">
